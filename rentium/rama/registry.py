...
from . import landlord_capabilities
...
TOOL_FUNCTIONS: tuple[Callable, ...] = (
    ...
    tool_functions.rename_business_document,
    tool_functions.file_business_document,
    landlord_capabilities.manage_business_documents,
    ...
    landlord_capabilities.list_saved_workflows,
    ...
    tool_functions.tenant_lease_status,
    ...
    landlord_capabilities.update_condition_inspection,
    ...
    tool_functions.mark_cleaning_deposit_paid,
    tool_functions.record_deposit_deduction,
    tool_functions.return_deposits,
    ...
    landlord_capabilities.manage_import_rows,
    ...
    landlord_capabilities.manage_viewing_availability,
    landlord_capabilities.schedule_appointment,
    landlord_capabilities.manage_agenda_event,
    ...
    landlord_capabilities.reorder_listing_media,
    ...
    landlord_capabilities.manage_property_group,
    ...
    landlord_capabilities.manage_showcase_settings,
    landlord_capabilities.manage_insight,
    landlord_capabilities.manage_notification_channel,
    landlord_capabilities.update_treasurer_settings,
    landlord_capabilities.save_last_workflow,
    landlord_capabilities.run_saved_workflow,
    landlord_capabilities.rename_saved_workflow,
    landlord_capabilities.archive_saved_workflow,
    landlord_capabilities.restore_saved_workflow,
)
